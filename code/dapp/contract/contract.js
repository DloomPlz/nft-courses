export const NFTContract = {
  abi: [
    ...
    {
      inputs: [{ internalType: 'uint256', name: 'new_price', type: 'uint256' }],
    ...
    },
    {
      inputs: [],
      name: 'sellingStep',
      outputs: [{ internalType: 'enum Neon.Step', name: '', type: 'uint8' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
    ...
    {
      inputs: [{ internalType: 'uint256', name: '_step', type: 'uint256' }],
      name: 'setStep',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
